...
export const HEATER_POSITION: [number, number, number] = [-1.5, 0.19, 0];
...
export const CHEMICALS: Record<string, Chemical> = {
    ...
    'CALCIUM_CARBONATE': {
        id: 'CALCIUM_CARBONATE', name: 'Canxi Cacbonat', formula: 'CaCO₃', color: '#f5f5f4', type: 'solid', meshStyle: 'mound', ph: 9.0, description: 'Chất phổ biến trong đá/vỏ sò.',
        thermalDecomposition: { minTemperature: 800, product: 'CAO', effect: 'smoke', message: 'Nhiệt phân: CaCO₃ → CaO + CO₂' }
    },
    'CAO': { id: 'CAO', name: 'Vôi Sống', formula: 'CaO', color: '#ffffff', type: 'solid', meshStyle: 'mound', ph: 12.5, description: 'Canxi Oxit.' }, // Added for thermal decomp
    ...
    // Added for exam mode
    'PHENOLPHTHALEIN': { id: 'PHENOLPHTHALEIN', name: 'Phenolphthalein', formula: 'C₂₀H₁₄O₄', color: '#f8fafc', type: 'liquid', meshStyle: 'flask', ph: 7.0, description: 'Chất chỉ thị màu.' }
};
...
export const REACTION_REGISTRY: ReactionEntry[] = [
    ...
    { reactants: ['NaOH', 'PHENOLPHTHALEIN'], product: 'NaOH', resultColor: '#f472b6', effect: 'bubbles', temperature: 25, message: 'Chất chỉ thị đổi màu hồng trong môi trường kiềm.' }
];
