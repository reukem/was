...
class GeminiService {
    ...
    async callGeminiAPI(userMessage: string): Promise<string> {
        // [Sentinel Security Fix] Wrap apiKey in encodeURIComponent to prevent HTTP parameter injection
                 ...
                 <form onSubmit={onSubmit} className="p-3 bg-slate-900/50 border-t border-white/5">
                     <div className="relative flex items-center">
                         <textarea
                             ...
                             rows={1}
                             maxLength={1000} // [Sentinel Security Fix] Add maxLength limit to mitigate DoS
                         />
