...
export async function speakTTS(text: string, lang: 'EN' | 'VN', isMuted: boolean) {
    ...
    // The AudioService now handles both ElevenLabs and native fallback internally
                ...
                <div className="pointer-events-auto bg-[#1a1f30] rounded-2xl p-5 shadow-[0_4px_20px_rgba(0,0,0,0.5)] flex flex-col items-start border border-slate-700/50">
                    ...
                    <div className="flex gap-2 mt-4 w-full">
                         <button
                             ...
                             className={`flex-1 border rounded-lg px-4 py-2 text-xs font-bold transition-colors shadow-inner flex items-center justify-center gap-2 ${
                                 isAAA
